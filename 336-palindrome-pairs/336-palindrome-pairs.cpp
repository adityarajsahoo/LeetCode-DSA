// TRIE: https://leetcode.com/problems/palindrome-pairs/discuss/2585494/C%2B%2B-or-Trie-or-Related-Problems
struct TrieNode {
    TrieNode *next[26] = {};
    int index = -1;
...
public:
    ...
    vector<vector<int>> palindromePairs(vector<string>& A) { // A = words
        int N = A.size();
