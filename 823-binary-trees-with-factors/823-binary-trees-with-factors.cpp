// https://leetcode.com/problems/binary-trees-with-factors/discuss/2400129/C%2B%2B-oror-DP-%2B-Map-oror-Easy-Understanding
class Solution {
public:
    const int mod = 1e9 + 7;
    int numFactoredBinaryTrees(vector<int>& arr) {
        ...
        return ans%mod;//return toatl sum after taking modulus3
    }
};